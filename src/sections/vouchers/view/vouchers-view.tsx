...
//
import { fetchOneVoucher, fetchVouchersList, setVoucher } from 'src/redux/store/thunks/defaultVouchers';
...
export default function OrdersListView() {
  ...
  const VoucherSchema = Yup.object().shape({
    ...
    // discountAmount: discountTypeToggle === 'FIXED' ? Yup.number().required('Field is required').typeError('Must be a valid number') : Yup.number().typeError('Must be a valid number'),
  ...
  const createVoucherFun = () => {
    const fotmData = {
      ...
      coverageAll: voucherData?.coverageAll || false,
    };
    console.log("voucherData", fotmData);
  }
                      ...
                      <FormControlLabel
                        control={
                          <Checkbox
                            size="medium"
                            onChange={(e) => {
                              setVoucherData({ ...voucherData, coverageAll: e.target.checked })
                            }}
                            name='coverageAll'
                            color="primary"
                            checked={voucherData?.coverageAll || false}
                          />
                        }
                        label="All Products"
                      />
